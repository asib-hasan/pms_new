                ...
                <div class="card rounded-0">
                    ...
                    <div class="card-body">
                        @forelse($low_quantity_items AS $item)
                            <a href="javascript:void(0)" style="font-weight:bold;padding: 5px;background: white;border: 1px solid maroon;color: black;border-radius: 50px;margin-bottom: 5px;display: inline-block">
                                            ...
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    <form method="POST" action="">
                                                        <div class="card mt-3">
                                                            <div class="card-header font-weight-bold">Order History - Invoice ID -
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div>
                                                                            ...
                                                                            @endphp
                                                                            @if($customer)
                                                                                <h4 style="color: black;font-weight: bold">Customer Information</h4>
